...
const NewTaskPage = () => {
  ...
  const handleRegisterTask = ({ description, finishedAt, startedAt }) => register(
    userId, { description, finishedAt, startedAt }, {
  ...
  return (
    <div className="NewTaskPage Flex Flex--vertical-alignment Flex--justify-center Flex--align-center">
      ...
      <div className="NewTaskPage__form">
        <TaskForm onSubmit={handleRegisterTask} hide={{ responsible: true }} />
      </div>
    </div>
  );
};
